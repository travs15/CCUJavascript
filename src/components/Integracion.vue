    ...
    methods: {
        createMap() {
            ...
            loadModules(
                ...
                view.whenLayerView(coberturaDpto).then(renderChart);
                        ...
                        promise = view.hitTest(event.x, event.y)
                            .then(function(hit) {
                                ...
                                if (results.length) {
                                    ...
                                    console.log(results);
                                    console.log(graphic.getAttribute("NOMBRE_DPT"));

                                    var depto = graphic.getAttribute("NOMBRE_DPT");
                                    var cob = graphic.getAttribute("COBERTURA");

                                    var newData = [
                                        {name: depto, value: cob},
                                        {name: "nulo", value: 100 - cob}
                                    ];
